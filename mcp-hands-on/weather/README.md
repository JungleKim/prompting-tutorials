...
### API 인증 정보
미국 기상청(NWS) API는 별도의 API 키가 필요하지 않습니다. 다만, 사용 시 요청 헤더에 사용자 에이전트(User-Agent)를 포함해야 합니다. 이 프로젝트에서는 자동으로 처리됩니다.
...
- [미국 기상청(NWS) API 문서](https://www.weather.gov/documentation/services-web-api)
